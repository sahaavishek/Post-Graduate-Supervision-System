...
import { User, Mail, Phone, Briefcase, Users, BookOpen, Edit2, Save, X, LogOut, Settings, Camera } from "lucide-react"
...
export default function SupervisorProfile() {
  ...
  const [profileData, setProfileData] = useState({
    ...
    email: "sarah.johnson@utm.my",
    phone: "+60 12-987 6543",
    department: "Computer Science",
    position: "Associate Professor",
    officeLocation: "Block N28, Level 3, Room 305",
    currentStudents: 8,
    maxCapacity: 10,
    researchInterests: "Artificial Intelligence, Machine Learning, Natural Language Processing, Computer Vision",
    qualifications: "PhD in Computer Science (MIT), MSc in AI (Stanford)",
  })
