...
export default function AdminUsersPage() {
  ...
  const [newUserData, setNewUserData] = useState({ role: "", name: "", email: "", phone: "" })
  ...
  const [studentsState, setStudentsState] = useState(students) // Added state for real-time updates
  const [supervisorsState, setSupervisorsState] = useState(supervisors) // Added state for real-time updates
  const [adminsState, setAdminsState] = useState(admins) // Added state for real-time updates
  ...
  const handleAddUser = () => {
    ...
    if (newUserData.role === "student") {
      const newStudent = {
        ...
        program: "PhD Computer Science",
        progress: 0,
        enrollmentDate: newUser.joinedDate,
        expectedCompletion: "TBD",
      }
      setStudentsState([newStudent, ...studentsState])
      ...
      setAdminsState([newAdmin, ...adminsState])
    }

    toast({
      title: "User Added",
      description: `${newUserData.name} has been successfully added to the system.`,
    })
    setIsAddUserOpen(false)
    setNewUserData({ role: "", name: "", email: "", phone: "" })
  }
  ...
  const handleSaveEditDetails = () => {
    ...
    // Update the appropriate state array based on user type
    ...
    } else if (selectedUser.department) {
      // It's a supervisor
      setSupervisorsState(
                    ...
                    >
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem onClick={() => handleSendMessage(student)}>Send Message</DropdownMenuItem>
                          <DropdownMenuSeparator />
                          <DropdownMenuItem
                    ...
                    >
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem onClick={() => handleSendMessage(supervisor)}>
                            Send Message
                          </DropdownMenuItem>
                          <DropdownMenuSeparator />
                          <DropdownMenuItem
                    ...
                    >
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem onClick={() => handleSendMessage(admin)}>Send Message</DropdownMenuItem>
                          <DropdownMenuSeparator />
                          <DropdownMenuItem
                            className="text-destructive"
                            onClick={() => handleDeactivateUser(admin.name)}
                          >
                            Deactivate Account
                          </DropdownMenuItem>
                        </DropdownMenuContent>
          ...
          {selectedUser && (
            <div className="space-y-6">
              ...
              <div>
                <Label className="text-muted-foreground mb-2 block">Overall Progress</Label>
                <div className="flex items-center gap-2">
                  <Progress value={selectedUser.progress || 0} className="flex-1" />
